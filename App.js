...
function App() {
  return (<div className="row d-flex align-items-center justify-content-center">
    <div className="col-sm-4">
      <div className="card mb-5 mb-lg-0" style={{ width: "25rem" }}>
        <div className="card-body">
          ...
          <ul>
            ...
            <li className="text-muted mb-2"><span><i class="fa fa-times" aria-hidden="true"></i></span> Unlimited Private Projects</li>
            <li className="text-muted mb-2"><span><i class="fa fa-times" aria-hidden="true"></i></span> Dedicated Phone Support</li>
            <li className="text-muted mb-2"><span><i class="fa fa-times" aria-hidden="true"></i></span> Free Subdomain</li>
            <li className="text-muted mb-2"><span><i class="fa fa-times" aria-hidden="true"></i></span> Monthly Status Reports</li>
          </ul>
